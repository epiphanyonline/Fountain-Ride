        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-3">
              Review submitted vehicles, check owner pricing, and approve
              suitable cars into your hidden fleet list.
            </p>
          </div>
                ...
                <div className="mt-6">
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-sm border rounded-2xl overflow-hidden">
                      ...
                      <tbody>
                        <PriceRow
                          route="Lagos Daily Hire"
                          value={app.lagos_daily_rate}
                          addMargin={addMargin}
                          formatNaira={formatNaira}
                        />
                        <PriceRow
                          route="Airport Pickup"
                          value={app.airport_pickup_rate}
                          addMargin={addMargin}
                          formatNaira={formatNaira}
                        />
                        <PriceRow
                          route="Lagos → Abeokuta"
                          value={app.lagos_to_abeokuta_rate}
                          addMargin={addMargin}
                          formatNaira={formatNaira}
                        />
                        <PriceRow
                          route="Lagos → Ado-Ekiti"
                          value={app.lagos_to_ado_ekiti_rate}
                          addMargin={addMargin}
                          formatNaira={formatNaira}
                        />
                        <PriceRow
                          route="Lagos → Akure"
                          value={app.lagos_to_akure_rate}
                          addMargin={addMargin}
                          formatNaira={formatNaira}
                        />
                        <PriceRow
                          route="Lagos → Ibadan"
                          value={app.lagos_to_ibadan_rate}
                          addMargin={addMargin}
                          formatNaira={formatNaira}
                        />
                        <PriceRow
                          route="Lagos → Ile-Ife"
                          value={app.lagos_to_ile_ife_rate}
                          addMargin={addMargin}
                          formatNaira={formatNaira}
                        />
                        <PriceRow
                          route="Lagos → Ondo"
                          value={app.lagos_to_ondo_rate}
                          addMargin={addMargin}
                          formatNaira={formatNaira}
                        />
                        <PriceRow
                          route="Lagos → Osogbo"
                          value={app.lagos_to_osogbo_rate}
                          addMargin={addMargin}
                          formatNaira={formatNaira}
                        />
                        <PriceRow
                          route="Overnight Allowance"
                          value={app.overnight_allowance}
                          addMargin={addMargin}
                          formatNaira={formatNaira}
                        />
                      </tbody>
